...
<div class="m-block-header" id="div-header">
    ...
    <a href="ord" class="m-index-icon">保存</a>
</div>
<div class=""></div>
...
<form class="layui-form" action="">
    <div class="addrcon">
        <ul>
            <li><em>收货人</em><input id="name" type="text" placeholder="请填写真实姓名"></li>
            <li><em>手机号码</em><input id="tel" type="number" placeholder="请输入手机号"></li>
            <li><em>所在区域</em><input id="demo1" type="text"  name="input_area" placeholder="请选择所在区域"></li>
            <li class="addr-detail"><em>详细地址</em><input id="ads" type="text" placeholder="20个字以内" class="addr"></li>
        </ul>
