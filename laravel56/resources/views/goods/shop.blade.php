...
<div class="page-group">
    <div id="page-photo-browser" class="page">
        ...
        <div class="pro_info">
            ...
            <h2 class="gray6" goods_id="{{$v->goods_id}}">

                  (第<em id='Period'>{{$v->goods_id}}</em>潮)
               <span>{{$v->goods_name}}</span>
                <input type="button" value="加入购物车" 	class="layui-btn">
            </h2>
            <div class="purchase-txt gray9 clearfix">
                价值：￥{{$v->goods_selfprice}}
            </div>
            <div class="clearfix">
...
@endforeach
        ...
        <div class="pro_foot">
            <a href="" class="">潮购<span class="dotting"></span></a>
            <a href="" class="shopping">参与</a>
            <span href="" class="fr"><a href="cart"><i><b num="1" >{{$data}}</b></i></a></span>
        </div>
    </div>
</div>
</div>
    ...
    $(document).ready(function(){
        layui.use("layer",function(){
            ...
            $(".pro_info").find(".gray6").click(function(){
                    ...
                    var data = {};//json数据格式
                    var goods_id = $('.gray6').attr('goods_id');
                    ...
                    $.ajax({
                        ...
                        success: function (msg) {
                            if(msg.status==0){
                                layer.confirm("未登录请先登录",{title:"加入购物车"},function(index) {
                                    layer.msg(msg.msg);
